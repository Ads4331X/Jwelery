        ...
        <Box className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
          ...
          <Box className="flex flex-wrap justify-center gap-3">
            <Button
              ...
              className="rounded-full! bg-linear-to-br! from-amber-700! to-amber-500! px-6! py-2.5! text-xs! font-bold! uppercase! tracking-widest! text-white! shadow-[0_8px_24px_rgba(180,83,9,0.5)]"
            >
              Explore Collection
            </Button>
            <Button
        ...
        <Box className="relative flex w-1/2 items-center justify-center overflow-hidden bg-[#fffdf8] px-8 xl:px-16">
          ...
          <Box className="relative max-w-md">
            ...
            <Box className="mt-8 flex flex-wrap gap-4">
              <Button
                onClick={() => navigate("/products")}
                className="rounded-full! bg-linear-to-br! from-amber-700! to-amber-600! px-6! py-2.5! text-xs! font-bold! uppercase! tracking-widest! text-white! shadow-[0_8px_24px_rgba(180,83,9,0.3)]"
              >
                Explore Collection
              </Button>
              <Button
